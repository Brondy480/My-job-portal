...
const MyJobs = () => {
    const email = "brondyk09@gmail.com"
    ...
    useEffect(() => {
        setIsLoading(true)
        fetch(`http://localhost:3000/myJobs/brondyk09@gmail.com`).then(res => res.json()).then(data => {
            setJobs(data)
    ...
    const handleSearch = () => {
        const filter = jobs.filter((job) => job.jobsTitle.toLowerCase().indexOf(searchText.toLowerCase()) !== -1);
        setJobs(filter);
        setIsLoading(false);
    }
    ...
    return <div className='max-w-sreen-2xl container mx-auto xl:px-24 px-4'>
        <div className='my-jobs-container'>
            <h1 className='text-center p-4'></h1>
